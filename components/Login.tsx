  ...
  return (
    ...
    >
      ...
      >
        ...
        <button 
          onClick={onCancel}
          className="absolute top-3 right-3 md:top-6 md:right-6 p-3 md:p-2 text-slate-400 hover:text-white hover:bg-white/10 rounded-full transition-all z-50 touch-manipulation"
          aria-label="닫기"
        >
