                      ...
                      <div className="relative z-10">
                        <div className="flex justify-between items-start mb-2 md:mb-3">
                          <div className="flex flex-col">
                            <h4 className={`text-xl md:text-3xl font-bold transition-colors duration-300 tracking-tight text-slate-200 group-hover:text-white`}>
                              {feature.title}
                            </h4>
                          </div>
                        ...
                        <p className={`text-sm md:text-lg leading-snug font-light transition-colors break-keep text-slate-500 group-hover:text-slate-300`}>
                          {feature.description}
                        </p>
                      </div>
                    </div>
