  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="bg-[#0a0f1e]/90 backdrop-blur-2xl border border-white/10 rounded-[2rem] md:rounded-[2.5rem] shadow-[0_40px_80px_rgba(0,0,0,0.7)] relative w-full max-w-6xl flex flex-col md:flex-row overflow-hidden max-h-[90vh]"
      >
        ...
        <div className="hidden md:flex md:w-5/12 bg-gradient-to-br from-brand-dark to-[#0f172a] p-10 flex-col justify-between relative overflow-hidden border-r border-white/5">
           ...
           <div className="relative z-10">
             ...
             <p className="text-slate-400 text-lg leading-relaxed mb-12">
               ...
               <p className="text-brand-accent/90 text-base font-medium leading-relaxed mb-12">
...
<ul className="space-y-8">
  ...
  <li className="flex items-start gap-4">
    ...
    <div>
      <h4 className="text-white font-bold text-lg mb-1">선수 미래 성적 예측</h4>
      <p className="text-slate-400 text-base leading-relaxed">현재 기록을 넘어, 다음 시즌의 가능성을 데이터로 확인해보세요.</p>
    </div>
  </li>
  ...
  <li className="flex items-start gap-4">
    ...
    <div>
      <h4 className="text-white font-bold text-lg mb-1">FA 시장 등급 분석</h4>
      <p className="text-slate-400 text-base leading-relaxed">성적을 나열하는 데 그치지 않고, 선수의 시장 가치를 구조적으로 해석합니다.</p>
    </div>
  </li>
  ...
  <li className="flex items-start gap-4">
    ...
    <div>
      <h4 className="text-white font-bold text-lg mb-1">나만의 대시보드</h4>
      <p className="text-slate-400 text-base leading-relaxed">관심 선수와 핵심 예측 결과를 모아, 나만의 데이터 화면으로 관리하세요.</p>
    </div>
  </li> {/* <-- 여기서 닫아주어야 합니다 */}

  {/* 4. 골든글러브 예측 (색상을 Amber로 변경해봤어요!) */}
  <li className="flex items-start gap-4">
    ...
    <div>
      <h4 className="text-white font-bold text-lg mb-1">골든글러브 예측</h4>
      <p className="text-slate-400 text-base leading-relaxed">역대 수상자들의 데이터 패턴을 정밀 분석하여, 올 시즌 포지션별 가장 유력한 후보를 예측합니다.</p>
    </div>
  </li>
</ul>
           </div>
        ...
        <div className="w-full md:w-7/12 p-6 md:p-10 relative overflow-y-auto custom-scrollbar">
          ...
          <motion.div 
            ...
            className="space-y-3"
          >
            <label className="text-lg font-bold text-slate-400 uppercase tracking-wider block ml-1">닉네임</label>
          ...
          <motion.div 
            ...
            className="space-y-3"
          >
            <label className="text-lg font-bold text-slate-400 uppercase tracking-wider block ml-1">이메일</label>
          ...
          >
            <div className="space-y-4">
              <label className="text-lg font-bold text-slate-400 uppercase tracking-wider block ml-1">비밀번호</label>
              <div className="relative group">
                <input
                  type="password"
                  name="password"
            ...
            <div className="space-y-4">
              <label className="text-lg font-bold text-slate-400 uppercase tracking-wider block ml-1">비밀번호 확인</label>
              <div className="relative group">
                <input
                  type="password"
          ...
          <motion.div 
            ...
            className="space-y-3"
          >
            <label className="text-lg font-bold text-slate-400 uppercase tracking-wider block ml-1">선호 구단</label>
            <div className="relative group">
              <select
              ...
              >
                ...
                {KBO_TEAMS.map(team => (
                  <option key={team} value={team} className="bg-slate-900 text-white py-3">
                    {team}
                  </option>
                ))}
              </select>
              <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-8 text-slate-400">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Find My Team Link */}
            <div className="mt-4 flex items-center justify-between bg-white/5 rounded-2xl p-6 border border-white/5 hover:bg-white/10 transition-colors">
              <div className="flex items-center gap-3">
                <span className="w-2 h-2 rounded-full bg-brand-accent animate-pulse"></span>
                <span className="text-base text-slate-400">아직 응원하는 팀을 못 고르셨나요?</span>
              </div>
              <button
                type="button"
                onClick={onFindTeamClick}
                className="text-base font-bold text-brand-accent hover:text-white transition-colors flex items-center gap-2 group"
              >
                나의 팀 찾기
